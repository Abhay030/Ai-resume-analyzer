...
const Upload = () => {
    ...
    const handleAnalyze = async ({ companyName, jobTitle, jobDescription, file }: { companyName: string, jobTitle: string, jobDescription: string, file: File }) => {
        ...
        // Update resume index for "Previously Analyzed" section
        try {
            const existingIndex = await kv.get('resume-index');
            let index: Array<{
                id: string;
                companyName: string;
                jobTitle: string;
            ...
            index.unshift({
                ...
                hireabilityVerdict: data.hireability?.verdict || 'Analyzed',
                analyzedAt: Date.now(),
            });
            ...
            await kv.set('resume-index', JSON.stringify(index));
        } catch (error) {
